...
| **4B** | **Knowledge Graph + Relationship** | **Graph Nodes/Edges 7 kinds + 6 edge types, Merge Duplicates, Entity Resolution, Edge Proposals (applied=false)** | **2026-08** | **⏳ In Progress (S10 Kickoff ✅)** | **10%** |
